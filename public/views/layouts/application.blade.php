...
<body>
 ...
 <script src="{{ asset('packages/node_modules/underscore/underscore-min.js') }}"></script>
 <script src="{{ asset('packages/node_modules/backbone/backbone-min.js') }}"></script>
 <script src="{{ asset('packages/node_modules/mustache/mustache.js') }}"></script>
